...
public:
    ...
    bool init() {
        ...
        app_->register_state_handler(
                std::bind(&response_example::on_state, this,
                        std::placeholders::_1));
        app_->register_message_handler(
                RequestResponse_SERVICE_ID, RequestResponse_INSTANCE_ID, RequestResponse_METHOD_ID,
                std::bind(&response_example::on_message, this,
                        std::placeholders::_1));
    ...
    void offer() {
        ...
        app_->offer_service(RequestResponse_SERVICE_ID, RequestResponse_INSTANCE_ID);
    }
    ...
    void stop_offer() {
        ...
        // _major: 服务的主版本号，默认为DEFAULT_MAJOR
        // _minor: 服务的次版本号，默认为DEFAULT_MINOR
        app_->stop_offer_service(RequestResponse_SERVICE_ID, RequestResponse_INSTANCE_ID);
    }
...
#ifndef VSOMEIP_ENABLE_SIGNAL_HANDLING
    response_example *its_sample_ptr(nullptr);
